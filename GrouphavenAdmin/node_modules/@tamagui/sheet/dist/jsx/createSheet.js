  ...
  const SheetHandle = Handle.styleable(
    ...
    forwardRef(
      ({
        ...
        const context = useSheetContext(SHEET_NAME, __scopeSheet), { hasFit, removeScrollEnabled, frameSize, contentRef, open } = context, composedContentRef = useComposedRefs(forwardedRef, contentRef), offscreenSize = useSheetOffscreenSize(context), sheetContents = useMemo(() => (
          // @ts-expect-error
          /* @__PURE__ */ jsxs(
            Frame,
            {
