...
import { ReactNativeFeatureFlags } from "../FeatureFlags.native.js";
import NativeEventEmitter from "../NativeEventEmitter/index.native.js";
import RCTDeviceEventEmitter from "../NativeEventEmitter/RCTDeviceEventEmitter.native.js";
  ...
  API = {
    ...
    disableQueue: function () {
      if (invariant(nativeOps, "Native animated module is not available"), ReactNativeFeatureFlags.animatedShouldDebounceQueueFlush()) {
        ...
        clearImmediate(prevTimeout), flushQueueTimeout = setTimeout(API.flushQueue, 0);
      } else API.flushQueue();
    },
    flushQueue: function () {},
    /*
