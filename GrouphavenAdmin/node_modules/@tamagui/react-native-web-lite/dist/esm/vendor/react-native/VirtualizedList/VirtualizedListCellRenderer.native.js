  ...
  function CellRenderer2() {
    ...
    return _this = _call_super(this, CellRenderer2, arguments), _define_property(_this, "state", {
      ...
      highlight: function () {
        ...
        _this.props.onUpdateSeparators([cellKey, prevCellKey || null], {
          highlighted: !0
        });
      },
      ...
      updateProps: function (select, newProps) {
        ...
        _this.props.onUpdateSeparators([select === "leading" ? prevCellKey || null : cellKey], newProps);
      }
  ...
  return _create_class(CellRenderer2, [{
    ...
    value: function () {
      var {
        ...
        itemSeparator = /* @__PURE__ */React.isValidElement(ItemSeparatorComponent) ? ItemSeparatorComponent : ItemSeparatorComponent && /* @__PURE__ */_jsx(ItemSeparatorComponent, {
