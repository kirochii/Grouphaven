...
const AccordionTriggerFrame = (0, import_web.styled)(import_collapsible.Collapsible.Trigger, {
  ...
  const itemContext = useAccordionItemContext(), { children, ...rest } = props, [height, setHeight] = React.useState(0), onLayout = (0, import_web.useEvent)(({ nativeEvent }) => {
    nativeEvent.layout.height && setHeight(nativeEvent.layout.height);
  });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_web.View, { ref, height: itemContext.open ? height : 0, ...rest, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_web.View,
    {
      position: "absolute",
      width: "100%",
